...
Factors that decrease likelihood of readmission <30 days are the following: no insulin prescribed, steady dosage, or increase all have a decreased effect on likelihood of short term readmission. 
...
Problems, solutions, and futher investigation
...
All variables are significant at the .05 level according to the Anova test, but for robustness the two with the highest P values are being removed. After removing `num_lab_procedures` and `max_glu_serum` all variables are significant at the .01 level according to the Anova test. 
