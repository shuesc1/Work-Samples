...
Using sources to triangulate true Denver county zipcodes ([7](https://www.unitedstateszipcodes.org/), [8](https://www.denvergov.org/media/gis/WebDocs/Citywide/Neighborhoods.pdf)), I included (or failed to deem unnecessary) the following zipcodes from the questionable list: 80110, 80265, 80266, 80292, and 80295. See the [appendix]() for the final master list of zipcodes used.
...
# top 3 -- 8-16, 8-61, 8-32
```

## Most frequent offenses: 8-16, 8-61, 8-32
